...
<head>
    ...
    <title>Exercise 1: Getting Started with PHP - Haneeta</title>
</head>
<body>
    <h3>3.1 Write PHP code to output the following message: Hello world! My name is "David"<h3>
        ...
        <h3>3.3 Define three variables: $g1 = 5, $g2 = 4, and $g3 = 5. These variables 
            ...
            information, create an HTML table within your PHP code. The table should be structured with columns for 
